...
export default function LoginPage() {
  ...
  async function signInOAuth(provider: "google" | "github") {
    ...
    try {
      ...
      // Success: the browser is redirecting to the provider. Keep the button
      // in its loading state through the navigation rather than flashing back.
    } catch {
        ...
        >
          ...
          <div className="mt-7 space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-2.5 text-sm font-medium text-[#1f1f1f] transition-colors hover:bg-white/90 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/50 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
            >
              {oauthBusy === "google" ? (
                <>
                  <Spinner />
            ...
            <button
              ...
              disabled={oauthBusy !== null || busy}
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-line/15 bg-line/[0.04] px-4 py-2.5 text-sm font-medium text-ink transition-colors hover:bg-line/10 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/50 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
            >
              {oauthBusy === "github" ? (
                <>
                  <Spinner />
          ...
          <form onSubmit={(e) => void handleEmail(e)} className="space-y-3">
            ...
            <button type="submit" disabled={busy || oauthBusy !== null} className={btnPrimary + " w-full py-2.5"}>
